...
type RepeatedRepeatedString struct {
	...
	// values is the underlying string matrix.
...
type ChangeControlKey struct {
	...
	// id is the ID of a change control.
...
type Action struct {
	...
	// timeout (optional) is the maximum duration
...
type StageConfig struct {
	...
	Name *wrapperspb.StringValue `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty"`
	// action (optional) is the action to perform on stage
	// execution.
	Action *Action `protobuf:"bytes,2,opt,name=action,proto3" json:"action,omitempty"`
	// rows (optional) is a series of rows of parallel stages
...
//     "1-2":  { name: "stages 1-2", rows: [["1a", "1b"], ["2"]] },
...
type StageConfigMap struct {
	...
	// values is the underlying map from stage ID to StageConfig.
...
type ChangeConfig struct {
	...
	// notes (optional) are any notes associated with the change.
...
type FlagConfig struct {
	...
	// notes (optional) are any notes associated with the flag value.
...
type TimestampFlagConfig struct {
	...
	// notes (optional) are the notes associated with the flag value.
	Notes *wrapperspb.StringValue `protobuf:"bytes,2,opt,name=notes,proto3" json:"notes,omitempty"`
}
...
type ChangeControlConfig struct {
	...
	// start (optional) is the flag to start (start.value set to
	...
	// schedule (optional) is the flag to schedule (schedule.value
...
// the same structure as StageMapConfig, but with each ID mapping
...
type StageMap struct {
	...
	// values is the underlying map from stage ID to Stage.
...
type ChangeControl struct {
	...
	// key uniquely identifies a change control.
	Key *ChangeControlKey `protobuf:"bytes,1,opt,name=key,proto3" json:"key,omitempty"`
...
type ApproveConfig struct {
	...
	// key uniquely identifies a change control.
	Key *ChangeControlKey `protobuf:"bytes,1,opt,name=key,proto3" json:"key,omitempty"`
	// approve is the flag to approve (approve.value set to true) or
	...
	// version (optional) is the timestamp of the change of the
...
var file_arista_changecontrol_v1_changecontrol_proto_rawDesc = []byte{
	...
	0x64, 0x75, 0x6c, 0x65, 0x3a, 0x06, 0xfa, 0x8d, 0x19, 0x02, 0x72, 0x77, 0x22, 0xa9, 0x02, 0x0a,
	...
	0x65, 0x52, 0x05, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x22, 0xac, 0x01, 0x0a, 0x08, 0x53, 0x74, 0x61,
	0x67, 0x65, 0x4d, 0x61, 0x70, 0x12, 0x45, 0x0a, 0x06, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x73, 0x18,
	0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x2d, 0x2e, 0x61, 0x72, 0x69, 0x73, 0x74, 0x61, 0x2e, 0x63,
	0x68, 0x61, 0x6e, 0x67, 0x65, 0x63, 0x6f, 0x6e, 0x74, 0x72, 0x6f, 0x6c, 0x2e, 0x76, 0x31, 0x2e,
	0x53, 0x74, 0x61, 0x67, 0x65, 0x4d, 0x61, 0x70, 0x2e, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x73, 0x45,
	...
	,
	...
	,
	...
	0x12, 0x30, 0x0a, 0x04, 0x75, 0x73, 0x65, 0x72, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1c,
	0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66,
	0x2e, 0x53, 0x74, 0x72, 0x69, 0x6e, 0x67, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x52, 0x04, 0x75, 0x73,
	0x65, 0x72, 0x22, 0xb9, 0x03, 0x0a, 0x0d, 0x43, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x43, 0x6f, 0x6e,
	...
	0x68, 0x65, 0x64, 0x75, 0x6c, 0x65, 0x3a, 0x06, 0xfa, 0x8d, 0x19, 0x02, 0x72, 0x6f, 0x22, 0xc9,
	0x01, 0x0a, 0x0d, 0x41, 0x70, 0x70, 0x72, 0x6f, 0x76, 0x65, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67,
	...
	0x6e, 0x74, 0x72, 0x6f, 0x6c, 0x4b, 0x65, 0x79, 0x52, 0x03, 0x6b, 0x65, 0x79, 0x12, 0x3d, 0x0a,
	0x07, 0x61, 0x70, 0x70, 0x72, 0x6f, 0x76, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x23,
	0x2e, 0x61, 0x72, 0x69, 0x73, 0x74, 0x61, 0x2e, 0x63, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x63, 0x6f,
	0x6e, 0x74, 0x72, 0x6f, 0x6c, 0x2e, 0x76, 0x31, 0x2e, 0x46, 0x6c, 0x61, 0x67, 0x43, 0x6f, 0x6e,
	0x66, 0x69, 0x67, 0x52, 0x07, 0x61, 0x70, 0x70, 0x72, 0x6f, 0x76, 0x65, 0x12, 0x34, 0x0a, 0x07,
	...
	0x6f, 0x6e, 0x3a, 0x06, 0xfa, 0x8d, 0x19, 0x02, 0x72, 0x77, 0x2a, 0x61, 0x0a, 0x0b, 0x53, 0x74,
	0x61, 0x67, 0x65, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x1c, 0x0a, 0x18, 0x53, 0x54, 0x41,
	...
	0x53, 0x5f, 0x43, 0x4f, 0x4d, 0x50, 0x4c, 0x45, 0x54, 0x45, 0x44, 0x10, 0x02, 0x2a, 0xa9, 0x01,
	0x0a, 0x13, 0x43, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x43, 0x6f, 0x6e, 0x74, 0x72, 0x6f, 0x6c, 0x53,
	0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x25, 0x0a, 0x21, 0x43, 0x48, 0x41, 0x4e, 0x47, 0x45, 0x5f,
	0x43, 0x4f, 0x4e, 0x54, 0x52, 0x4f, 0x4c, 0x5f, 0x53, 0x54, 0x41, 0x54, 0x55, 0x53, 0x5f, 0x55,
	...
	0x23, 0x0a, 0x1f, 0x43, 0x48, 0x41, 0x4e, 0x47, 0x45, 0x5f, 0x43, 0x4f, 0x4e, 0x54, 0x52, 0x4f,
	0x4c, 0x5f, 0x53, 0x54, 0x41, 0x54, 0x55, 0x53, 0x5f, 0x43, 0x4f, 0x4d, 0x50, 0x4c, 0x45, 0x54,
	0x45, 0x44, 0x10, 0x02, 0x12, 0x23, 0x0a, 0x1f, 0x43, 0x48, 0x41, 0x4e, 0x47, 0x45, 0x5f, 0x43,
	0x4f, 0x4e, 0x54, 0x52, 0x4f, 0x4c, 0x5f, 0x53, 0x54, 0x41, 0x54, 0x55, 0x53, 0x5f, 0x53, 0x43,
	0x48, 0x45, 0x44, 0x55, 0x4c, 0x45, 0x44, 0x10, 0x03, 0x42, 0x38, 0x5a, 0x36, 0x61, 0x72, 0x69,
...
var file_arista_changecontrol_v1_changecontrol_proto_msgTypes = make([]protoimpl.MessageInfo, 18)
var file_arista_changecontrol_v1_changecontrol_proto_goTypes = []interface{}{
	...
	(*ChangeControl)(nil),          // 16: arista.changecontrol.v1.ChangeControl
	(*ApproveConfig)(nil),          // 17: arista.changecontrol.v1.ApproveConfig
	nil,                            // 18: arista.changecontrol.v1.StageConfigMap.ValuesEntry
	nil,                            // 19: arista.changecontrol.v1.StageMap.ValuesEntry
	(*fmp.RepeatedString)(nil),     // 20: fmp.RepeatedString
	(*wrapperspb.StringValue)(nil), // 21: google.protobuf.StringValue
	(*wrapperspb.UInt32Value)(nil), // 22: google.protobuf.UInt32Value
	(*fmp.MapStringString)(nil),    // 23: fmp.MapStringString
...
var file_arista_changecontrol_v1_changecontrol_proto_depIdxs = []int32{
	20, // 0: arista.changecontrol.v1.RepeatedRepeatedString.values:type_name -> fmp.RepeatedString
	21, // 1: arista.changecontrol.v1.ChangeControlKey.id:type_name -> google.protobuf.StringValue
	21, // 2: arista.changecontrol.v1.Action.name:type_name -> google.protobuf.StringValue
	22, // 3: arista.changecontrol.v1.Action.timeout:type_name -> google.protobuf.UInt32Value
	23, // 4: arista.changecontrol.v1.Action.args:type_name -> fmp.MapStringString
	21, // 5: arista.changecontrol.v1.StageConfig.name:type_name -> google.protobuf.StringValue
	...
	18, // 8: arista.changecontrol.v1.StageConfigMap.values:type_name -> arista.changecontrol.v1.StageConfigMap.ValuesEntry
	21, // 9: arista.changecontrol.v1.ChangeConfig.name:type_name -> google.protobuf.StringValue
	21, // 10: arista.changecontrol.v1.ChangeConfig.root_stage_id:type_name -> google.protobuf.StringValue
	6,  // 11: arista.changecontrol.v1.ChangeConfig.stages:type_name -> arista.changecontrol.v1.StageConfigMap
	21, // 12: arista.changecontrol.v1.ChangeConfig.notes:type_name -> google.protobuf.StringValue
	24, // 13: arista.changecontrol.v1.FlagConfig.value:type_name -> google.protobuf.BoolValue
	21, // 14: arista.changecontrol.v1.FlagConfig.notes:type_name -> google.protobuf.StringValue
	25, // 15: arista.changecontrol.v1.TimestampFlagConfig.value:type_name -> google.protobuf.Timestamp
	21, // 16: arista.changecontrol.v1.TimestampFlagConfig.notes:type_name -> google.protobuf.StringValue
	...
	21, // 21: arista.changecontrol.v1.Stage.name:type_name -> google.protobuf.StringValue
	...
	21, // 25: arista.changecontrol.v1.Stage.error:type_name -> google.protobuf.StringValue
	19, // 26: arista.changecontrol.v1.StageMap.values:type_name -> arista.changecontrol.v1.StageMap.ValuesEntry
	21, // 27: arista.changecontrol.v1.Change.name:type_name -> google.protobuf.StringValue
	21, // 28: arista.changecontrol.v1.Change.root_stage_id:type_name -> google.protobuf.StringValue
	12, // 29: arista.changecontrol.v1.Change.stages:type_name -> arista.changecontrol.v1.StageMap
	21, // 30: arista.changecontrol.v1.Change.notes:type_name -> google.protobuf.StringValue
	25, // 31: arista.changecontrol.v1.Change.time:type_name -> google.protobuf.Timestamp
	21, // 32: arista.changecontrol.v1.Change.user:type_name -> google.protobuf.StringValue
	24, // 33: arista.changecontrol.v1.Flag.value:type_name -> google.protobuf.BoolValue
	21, // 34: arista.changecontrol.v1.Flag.notes:type_name -> google.protobuf.StringValue
	25, // 35: arista.changecontrol.v1.Flag.time:type_name -> google.protobuf.Timestamp
	21, // 36: arista.changecontrol.v1.Flag.user:type_name -> google.protobuf.StringValue
	25, // 37: arista.changecontrol.v1.TimestampFlag.value:type_name -> google.protobuf.Timestamp
	21, // 38: arista.changecontrol.v1.TimestampFlag.notes:type_name -> google.protobuf.StringValue
	25, // 39: arista.changecontrol.v1.TimestampFlag.time:type_name -> google.protobuf.Timestamp
	21, // 40: arista.changecontrol.v1.TimestampFlag.user:type_name -> google.protobuf.StringValue
	3,  // 41: arista.changecontrol.v1.ChangeControl.key:type_name -> arista.changecontrol.v1.ChangeControlKey
	13, // 42: arista.changecontrol.v1.ChangeControl.change:type_name -> arista.changecontrol.v1.Change
	14, // 43: arista.changecontrol.v1.ChangeControl.approve:type_name -> arista.changecontrol.v1.Flag
	14, // 44: arista.changecontrol.v1.ChangeControl.start:type_name -> arista.changecontrol.v1.Flag
	1,  // 45: arista.changecontrol.v1.ChangeControl.status:type_name -> arista.changecontrol.v1.ChangeControlStatus
	21, // 46: arista.changecontrol.v1.ChangeControl.error:type_name -> google.protobuf.StringValue
	15, // 47: arista.changecontrol.v1.ChangeControl.schedule:type_name -> arista.changecontrol.v1.TimestampFlag
	3,  // 48: arista.changecontrol.v1.ApproveConfig.key:type_name -> arista.changecontrol.v1.ChangeControlKey
	8,  // 49: arista.changecontrol.v1.ApproveConfig.approve:type_name -> arista.changecontrol.v1.FlagConfig
	25, // 50: arista.changecontrol.v1.ApproveConfig.version:type_name -> google.protobuf.Timestamp
	5,  // 51: arista.changecontrol.v1.StageConfigMap.ValuesEntry.value:type_name -> arista.changecontrol.v1.StageConfig
	11, // 52: arista.changecontrol.v1.StageMap.ValuesEntry.value:type_name -> arista.changecontrol.v1.Stage
